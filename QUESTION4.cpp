/*Q4) Create a simple calculator program which performs addition, subtraction, multiplication, 
division and absolute functions (absolute being if number is negative, make it positive, 
if it is positive, leave it as is)
*/
# include<iostream>
using namespace std;
